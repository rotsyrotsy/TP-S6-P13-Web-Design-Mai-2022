            ...
            <div class="col-lg-7 mx-auto text-white">
              ...
              <div class="row mt-5">
                <div class="col-12 text-center mt-xl-2">
                  <a class="text-white font-weight-medium" href="<?php echo site_url(); ?>ArticleCtrl">Retour à la page d'accueil</a>
                </div>
              </div>
              <div class="row mt-5">
                <div class="col-12 mt-xl-2">
                  <p class="text-white font-weight-medium text-center">Copyright &copy; 2022 Tout droit reservé.</p>
                </div>
              </div>
            </div>
          </div>
